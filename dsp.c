...
dsp_show_display_data (void)
{
  ...
  if (*display_data.total_down_size)
    fputs (display_data.total_down_size, stdout);
  else
    fputs (DSP_UNKNOWN_DISPLAY_DATA, stdout);
  fputc ('\n', stdout);
  ...
  if (*display_data.average_down_rate)
    fputs (display_data.average_down_rate, stdout);
  else
    fputs (DSP_UNKNOWN_DISPLAY_DATA, stdout);
  fputc ('\n', stdout);
  ...
  if (*display_data.peak_down_rate)
    fputs (display_data.peak_down_rate, stdout);
  else
    fputs (DSP_UNKNOWN_DISPLAY_DATA, stdout);
  fputc ('\n', stdout);
  ...
  if (*display_data.lowest_down_rate)
    fputs (display_data.lowest_down_rate, stdout);
  else
    fputs (DSP_UNKNOWN_DISPLAY_DATA, stdout);
  fputc ('\n', stdout);
}
